...
export const Icon = {
  ...
  undo:   (p) => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" {...p}><path d="M7 8H4V5" /><path d="M4.5 15.5A8 8 0 1 0 6 6.3L4 8" /></svg>,
};
